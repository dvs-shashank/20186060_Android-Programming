...
public class AnagramsActivity extends AppCompatActivity {
    ...
    public static final String START_MESSAGE = "Find words that can be formed by <big>%s</big>.";
    ...
    public void displayWordsGuessed () {
        TextView tv = (TextView) findViewById(R.id.resultId);
        name = findViewById(R.id.playerName);
        String pName = name.getText().toString();
        Toast.makeText(this,pName, Toast.LENGTH_SHORT).show();
        tv.setText(pName+" you guessed \t" + counter + " words");
    }
    ...
    public boolean defaultAction(View view) {
        ...
        TextView resultView = (TextView) findViewById(R.id.resultView);
        String playName = playerName.toString() ;
//        addStudents(playName);
...
//            databaseReference = FirebaseDatabase.getInstance().getReference();
    ...
    public void addStudents(String playerName) {
        name = findViewById(R.id.playerName);
        ...
        if (!TextUtils.isEmpty(sName)){
            ...
            Students students = new Students(id,sName,count);
            assert id != null;
            databaseReference.child(id).setValue(students);
            name.setText("");
        } else {
            Toast.makeText(AnagramsActivity.this,"type the students name",Toast.LENGTH_LONG).show();
        }
    }
