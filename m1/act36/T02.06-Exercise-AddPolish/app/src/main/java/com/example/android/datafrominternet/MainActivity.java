...
public class MainActivity extends AppCompatActivity {
    ...
    private TextView refForErrorMsg;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        refForErrorMsg = (TextView)findViewById(R.id.tv_error_message_display);
        // TODO (13) Get a reference to the error TextView using findViewById

        progressBarVariable = (ProgressBar)findViewById(R.id.pb_loading_indicator);
    ...
    public class GithubQueryTask extends AsyncTask<URL, Void, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            progressBarVariable.setVisibility(View.VISIBLE);
        }
        ...
        protected void onPostExecute(String githubSearchResults) {
            progressBarVariable.setVisibility(View.INVISIBLE);
